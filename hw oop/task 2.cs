...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("ordinary"); }
            public override void BuildSauce() { pizza.SetSauce("tomato"); }
            public override void BuildTopping() { pizza.SetTopping("vegetables"); }
        }
        /** "Director" */
        class Waiter
        {
        ...
        class BuilderExample
        {
            public static void Main(String[] args)
            {
                ...
                PizzaBuilder margarithaPB = new MargaritaPizzaBuilder();

                waiter.SetPizzaBuilder(margarithaPB);
