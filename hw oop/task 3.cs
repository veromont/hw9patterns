...
namespace Mediator.Examples
{
    ...
    class MainApp
    {
        static void Main()
        {
            ...
            Console.WriteLine("Mediator sent 'How are you?' to c1");
            m.Send("How are you?", c1);
            Console.WriteLine("Mediator sent 'Fine, thanks?' to c1");
            m.Send("Fine, thanks", c2);
            Console.WriteLine("Mediator sent 'I am Dima' to c1");
            m.Send("I am Dima", c3);
    ...
    {
        public ConcreteColleague3(Mediator m) : base(m)
        {
        }
        public void Send(string message)
        {
        ...
        public void Notify(string message)
        {
            Console.WriteLine("Colleague3 says hello");
        }
    }
}
